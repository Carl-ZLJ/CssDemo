...
function setState(state) {
    const { angle, timingFunction } = states[state]
    demo.style.setProperty('--stateAngle', angle)
    demo.style.setProperty('--ttf', timingFunction)

    demo.style.setProperty('--pointerEvents', state === 'idle' ? 'all' : 'none')
